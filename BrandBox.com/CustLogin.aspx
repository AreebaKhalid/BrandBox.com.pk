<%@ Page Title="" Language="C#" MasterPageFile="~/web.master" AutoEventWireup="true" CodeBehind="CustLogin.aspx.cs" Inherits="BrandBox.com.WebForm8" %>
                            ...
                            <article role="login">
                                    <form class="signup" name="SignUpForm" method="post">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <a href="Login.aspx" style="color:#f4511e">Login as Vendor</a>
                                    </form>
                            </article>
                        </div>
                    </div>
